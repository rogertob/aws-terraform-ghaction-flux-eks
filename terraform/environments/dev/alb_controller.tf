...
# v2.17.0 — https://raw.githubusercontent.com/kubernetes-sigs/aws-load-balancer-controller/v2.17.0/docs/install/iam_policy.json
resource "aws_iam_policy" "alb_controller" {
  name        = "${local.name}-alb-controller"
  description = "IAM policy for the AWS Load Balancer Controller (v2.17.0)"
    ...
    Statement = [
      ...
      },
      {
        ...
        Action = [
          ...
          "ec2:GetSecurityGroupsForVpc", "ec2:DescribeIpamPools",
